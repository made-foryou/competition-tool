...
use App\Actions\Auth\EnsureSecondFactorIsChallenged;
use App\Actions\Auth\MarkPasswordAsConfirmed;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    private function configureActions(): void
    {
        ...
        Fortify::authenticateThrough(fn (): array => array_filter([
            ...
            EnsureSecondFactorIsChallenged::class,
            AttemptToAuthenticate::class,
            PrepareAuthenticatedSession::class,
            MarkPasswordAsConfirmed::class,
        ]));
    }
    ...
    private function configureViews(): void
    {
        ...
        Fortify::twoFactorChallengeView(function (Request $request) {
            ...
            return Inertia::render('auth/two-factor-challenge', [
                'hasPasskeys' => (bool) $user?->hasPasskeysEnabled(),
            ]);
        });
