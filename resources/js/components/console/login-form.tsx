...
/**
 * Shared Made console login form: email/password fields, remember-me,
 * forgot-password link and passkey fallback. Used by both the admin login
 * page and the per-competition participant login page.
 */
